<?php
    ...
    class CartDB {
        ...
        public function add_to_cart($userID, $productID, $quantity) {
            $query = "INSERT INTO cart (userID, productID, quantity) VALUES (:userID, :productID, :quantity) ON DUPLICATE KEY UPDATE quantity = quantity + :quantity";
            $statement = Database::get_db()->prepare($query);
            $statement->bindValue(':userID', $userID);
        ...
        public function delete_from_cart($userID, $productID) {
