<?php 
    ...
    if ($is_logged_in) {
        $user_products = $product_db->find_by_id($_SESSION['userID']);
    } else {
        $user_products = array();
    }
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row">
                            <?php foreach ($products as $product): ?>
                                <div class="col-md-4 mb-4">
                                    <div class="card">
                                        <img src="<?php echo htmlspecialchars($product['image']); ?>" class="card-img-top" alt="<?php echo htmlspecialchars($product['name']); ?>" height="300">
                                        <div class="card-body">
                                            <h5 class="card-title">
                                            ...
                                            <p class="card-text">
                                                <strong>
                                                    Price: <?php echo "" . number_format($product['price'], 2) . " MKD"; ?>
                                                </strong>
                                            </p>
